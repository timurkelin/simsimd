 ...
 *
 *  Description:
 *    Declaration of the stream block for data input to the core
 *    From the Core perspective this block represents Data source.
 *
 */

#ifndef SIMD_SYS_STREAM_INCLUDE_SIMD_SYS_ST_INP_1_H_
#define SIMD_SYS_STREAM_INCLUDE_SIMD_SYS_ST_INP_1_H_
...
namespace simd {
   ...
   public:
      ...
      static inline std::string func( void ) { return "st_inp_1"; }
   ...
   private:
      static const std::size_t n_data_o = 1; // Number of the output ports from the module
      static const std::size_t n_ready  = 1;

      std::size_t smp_cnt  = 0;   // Sample counter
      std::size_t seg_addr = 0;   // Pool segment address
      ...
      std::size_t blk_size      = 0; // Block  size
...
#endif /* SIMD_SYS_STREAM_INCLUDE_SIMD_SYS_ST_INP_1_H_ */
