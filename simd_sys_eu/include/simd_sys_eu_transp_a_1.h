...
#ifndef SIMD_SYS_EU_INCLUDE_SIMD_SYS_EU_TRANSP_A_1_H_
#define SIMD_SYS_EU_INCLUDE_SIMD_SYS_EU_TRANSP_A_1_H_
...
namespace simd {
   ...
   class simd_sys_eu_transp_a_1_c
   : public simd::simd_sys_dmeu_c { // declare module class

   public:
      // Constructor
      simd_sys_eu_transp_a_1_c(
      ...
      static inline std::string func( void ) { return "eu_transp_a_1"; }
   ...
   protected:
      ...
      void  data_thrd(     // Data  interconnect thread
            void );
...
#endif /* SIMD_SYS_EU_INCLUDE_SIMD_SYS_EU_TRANSP_A_1_H_ */
