...
boost_pt::ptree init_dump(
   ...
   str2pt( std::string("")
      + "[{\"buf_regex\":\"^.*src1.*$\", \"time_start\":\"00.0" + TIME_US + "\", \"time_end\":\"finish\", \"size_res\":512, \"size_max\":1024, \"file\":\"dump_src1.mat\""
      + " },"
      + " {\"buf_regex\":\"^.*src2.*$\", \"time_start\":\"00.0" + TIME_US + "\", \"time_end\":\"finish\", \"size_res\":512, \"size_max\":1024, \"file\":\"dump_src2.mat\""
      + " },"
      + " {\"buf_regex\":\"^.*dst1.*$\", \"time_start\":\"00.0" + TIME_US + "\", \"time_end\":\"finish\", \"size_res\":512, \"size_max\":1024, \"file\":\"dump_dst1.mat\""
      + " },"
      + " {\"buf_regex\":\"^.*dst2.*$\", \"time_start\":\"00.0" + TIME_US + "\", \"time_end\":\"finish\", \"size_res\":512, \"size_max\":1024, \"file\":\"dump_dst2.mat\""
      + " }"
      + "]", elem );
